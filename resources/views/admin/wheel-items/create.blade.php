...
<div class="admin-card">
    ...
    <form method="POST" action="{{ route('admin.wheel-items.store') }}">
        @csrf
        ...
        <div class="form-grid">
            ...
            <div class="form-group">
                ...
                <input type="text" name="icon" value="{{ old('icon') }}" placeholder="مثال: ⭐ أو 🛡️ أو 🤝">
            </div>
            ...
            <div class="form-group full">
                ...
                <textarea name="description_he">{{ old('description_he') }}</textarea>
            </div>

            <div class="form-group full">
                <label>سؤال للتفكير بالعربية</label>
                <textarea name="question_ar">{{ old('question_ar') }}</textarea>
            </div>

            <div class="form-group full">
                <label>שאלה למחשבה בעברית</label>
                <textarea name="question_he">{{ old('question_he') }}</textarea>
            </div>
